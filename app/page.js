...
export default function Home() {
  ...
  const result = useMemo(() => getFoodResult(submittedFood), [submittedFood]);
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <input
              ...
              className="min-h-12 flex-1 rounded-2xl border border-slate-300 px-4 text-lg outline-none transition focus:border-orange-500 focus:ring-4 focus:ring-orange-100"
            />
            <button
              type="submit"
              className="min-h-12 rounded-2xl bg-slate-900 px-6 font-bold text-white transition hover:bg-orange-600 focus:outline-none focus:ring-4 focus:ring-orange-200"
            >
              Check food
            </button>
          </div>
